...
const Footer = () => {
    return (
        <footer id='contact' className="bg-black -900 p-4 py-8">
            <div className="container grid-cols-2 gap-4 p-4 md:grid-cols-3 grid mx-auto  justify-between">

                <div className="flex items-center ">
                    <img src="/logo.png" alt="Logo" className="  mr-2" />
                </div>
                <div className="flex items-center mt-4 text-xs md:text-lg  ">
                    <div className=" ml-4 ">
